 ...
 * Created on Jan 10th, 2023
 * Purpose:  This program prompts the user 
 * to enter their goal weight and current 
 * weight in grams, then calculates the number 
 * of cans of soda they can safely consume based 
 * on the assumption that the lethal dose for a 
 * mouse is proportional to the lethal dose for a human
 */
